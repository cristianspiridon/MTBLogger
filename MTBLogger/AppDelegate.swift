...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    override init() {
        let config = StravaConfig(
            clientId: 76754,
            clientSecret: "e4eade5e31b18a6b73114db578b378ed5d6c57f9",
            redirectUri: "mtblogger%3A%2F%2Fharmonybikes.co.uk",
...
//        RealmManager.shared.clearAllData()
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "MTBLogger")
